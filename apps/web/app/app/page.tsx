      ...
      <main className="dash">
        <header className="dash-masthead">
          <div className="dash-masthead-text">
            ...
            <h1>
              Good <em>afternoon</em>, <span className="dash-name">John.</span>
            </h1>
          </div>
          <ModeToggle mode={mode} onChange={setMode} />
        </header>

        {mode === "selling" ? <SellingDash /> : <BuyingDash />}
      </main>
      <SiteFooter />
    </>
  );
    ...
    <>
          ...
          <ul className="dispatch-list dispatch-list--tight">
            <li>
              <Link href="/app/messages" className="dispatch-row">
                ...
                <span className="dispatch-body">
                  <strong>{newEnquiriesCount} new enquiries</strong>
            ...
            <li>
              <Link href="/app/transactions" className="dispatch-row">
                ...
                <span className="dispatch-body">
                  <strong>
                    {transactionsAwaitingReviewCount} transactions awaiting review
                  </strong>
                  <span className="dispatch-sub">
      ...
      <section className="dash-row dash-row--split">
        ...
        <article className="dash-panel">
          ...
          <ul className="dispatch-list dispatch-list--tight">
            {authorityExpiringSoon.map((row, i) => (
              <li key={row.id}>
                <Link
    ...
    <>
      <section className="dash-kpis" aria-label="Headline metrics">
        ...
        <KpiTile
          kicker="ii"
          label="New replies"
          value={buyingNotifications.newAgentReplies}
        ...
        <KpiTile
          ...
          value={buyingNotifications.transactionsAwaitingReview}
          ...
          <ul className="dispatch-list dispatch-list--tight">
            <li>
              <Link href="/app/messages" className="dispatch-row">
                ...
                <span className="dispatch-body">
                  <strong>
                    {buyingNotifications.newAgentReplies} new agent replies
                  </strong>
                  <span className="dispatch-sub">
            ...
            <li>
              <Link href="/app/transactions" className="dispatch-row">
                ...
                <span className="dispatch-body">
                  <strong>
                    {buyingNotifications.transactionsAwaitingReview} transaction awaiting review
                  </strong>
                  <span className="dispatch-sub">
        ...
        <article className="dash-panel">
          ...
          <ul className="dispatch-list dispatch-list--tight">
            {savedSearches.map((s, i) => (
              <li key={s.id}>
                <Link href={"/app/saved/" + s.id} className="dispatch-row">
                  <span className="dispatch-folio">
                    No. {String(i + 1).padStart(2, "0")}
                  </span>
                  <span className="dispatch-body">
                    ...
                    <span className="dispatch-sub">
                      {s.criteria} · alerts {s.alertsOn ? "daily" : "off"}
                    </span>
                  </span>
                  <span className="dispatch-num">
                    <em>{s.newCount}</em>
