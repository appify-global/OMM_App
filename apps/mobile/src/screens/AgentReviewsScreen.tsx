...
const styles = StyleSheet.create({
  ...
  summaryLeft: {},
  agentName: { fontSize: 18, fontWeight: '500', color: brand.charcoal },
  ...
  bigNum: { fontSize: 40, fontWeight: '500', color: brand.charcoal },
  ...
  revName: { fontWeight: '500', color: brand.charcoal },
  revRole: { fontSize: 12, color: brand.sage, marginTop: 2 },
  revStarR: { fontWeight: '500', color: brand.charcoal, fontSize: 13 },
