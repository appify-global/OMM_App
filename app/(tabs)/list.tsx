...
function tabKeyFromSegmentQuery(q: string | undefined): TabKey | null {
  if (q === "live" || q === "contract" || q === "draft") return q;
  return null;
}
      ...
      >
        ...
        <View style={[styles.buyerCard, dashedShell]}>
          ...
          <Text style={styles.buyerBody}>
            Qualified buyers are currently searching for properties like yours.
            Connect instantly and move deals forward.
          </Text>
          <Pressable
        ...
        {activeSegment === "live" ? (
          <View style={styles.listingCard}>
            <View style={styles.imgWrap}>
              ...
              <View style={styles.badgeAuth}>
                <Text style={styles.badgeAuthText}>
                  Authority expires in 14 days
                </Text>
              </View>
            </View>
          ...
          <View style={styles.emptyTab}>
            <Text style={styles.emptyTitle}>
              {activeSegment === "contract" ? "Under contract" : "Drafts"}
            </Text>
