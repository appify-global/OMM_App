          ...
          <View key={r.id} style={styles.card}>
            ...
            <View style={styles.footRow}>
              <View style={styles.footLeft}>
                ...
                <Text style={styles.footState}>{r.alertsOn ? 'ALERTS ON' : 'ALERTS OFF'}</Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  listHeadL: { fontSize: 12, fontWeight: '600', color: brand.charcoal },
  listHeadR: { fontSize: 10, color: brand.sage, letterSpacing: 0.2, fontWeight: '600' },
  card: {
  ...
  cardTitle: { fontSize: 16, fontWeight: '600', color: brand.charcoal },
  inlineNew: { marginTop: 6, marginBottom: 2, alignSelf: 'flex-start' },
  badgePill: { backgroundColor: brand.charcoal, borderRadius: 4, paddingHorizontal: 7, paddingVertical: 2 },
  badgePillText: { color: brand.warmWhite, fontSize: 9, fontWeight: '800', letterSpacing: 0.3 },
  criteria: { fontSize: 14, color: brand.sage, marginTop: 6, lineHeight: 20 },
  rule: { height: StyleSheet.hairlineWidth, backgroundColor: 'rgba(138,155,142,0.3)', marginVertical: 12 },
  ...
  footState: { fontSize: 10, color: brand.sage, fontWeight: '600', letterSpacing: 0.2 },
